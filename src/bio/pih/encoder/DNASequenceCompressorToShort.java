 ...
 *
 */
public class DNASequenceCompressorToShort extends DNASequenceCompressor {
	
	/**
	 * @param subSequenceLength
	 * @throws ValueOutOfBoundsException
	 */
	public DNASequenceCompressorToShort(int subSequenceLength) throws ValueOutOfBoundsException {
